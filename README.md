...
<p align="center">
  <a href="#更新日志">更新日志</a> ·
  <a href="#flashtalk-14b-单卡实时优化">单卡优化</a> ·
  <a href="#当前能力">当前能力</a> ·
  <a href="#快速开始">快速开始</a> ·
...
| 日期 | 版本 | 变更 |
|---|---|---|
| 2026-05-06 | v0.3 | FlashTalk 14B 单卡实时优化：WSL2/FP8a8/adaptive prebuffer，首音 10s→3.5s |
| 2026-05-04 | v0.2 | 接入 FlashTalk 14B local mode、Qwen voice-clone TTS、DashScope ASR |
| 2026-04-28 | v0.1 | 初始开源：wav2lip/musetalk demo、WebRTC 基础链路、LLM/TTS 编排 |
...
在 NVIDIA RTX PRO 6000 Blackwell (96 GB) 单卡上，将 FlashTalk 14B 从"完全不可用"优化到接近实时对话。
